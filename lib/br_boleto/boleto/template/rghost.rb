    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          move_more(doc, 15.8, 0)
          doc.show boleto.data_vencimento.try(:strftime, '%d/%m/%Y') if boleto.data_vencimento
          ...
          move_more(doc, 1.7, 0)
          doc.show boleto.aceite_formatado
          ...
          if boleto.instrucoes
            ...
            move_more(doc, -15.8, -0.9)
            doc.show boleto.instrucoes1

            move_more(doc, 0, -0.4)
            doc.show boleto.instrucoes2

            move_more(doc, 0, -0.4)
            doc.show boleto.instrucoes3

            move_more(doc, 0, -0.4)
            doc.show boleto.instrucoes4

            move_more(doc, 0, -0.4)
            doc.show boleto.instrucoes5

            move_more(doc, 0, -0.4)
            doc.show boleto.instrucoes6
          end


          move_more(doc, 0.5, -1.9)
          doc.show "#{boleto.pagador.nome} - CPF/CNPJ: #{BrBoleto::Helper::CpfCnpj.new(boleto.pagador.cpf_cnpj).com_formatacao}" if boleto.pagador && boleto.pagador.cpf_cnpj
